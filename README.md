...
- [Числа (int, float)](##группа-числа-(int,-float))
- [Строки и символы](##группа-символы-истроки)
- [Логический тип данных](##группа-логический-тип-данных)
- [Условный оператор (if), оператор выбора (case)](##группа-условный-оператор-(if),-оператор-выбора-(case))
- [Циклы (for, while)](##группа-циклы-(for,-while))
...
## Группа Условный оператор (if), оператор выбора (case)
